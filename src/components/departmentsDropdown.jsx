...
//       setMessage("⚠️ Failed to load departments.");
//     }
//   };
...
//       setMessage("⚠️ Please enter a department name and select a system.");
//       return;
//     }
...
//       setMessage("⚠️ Please fill in all fields for edit.");
//       return;
//     }
...
//       const data = await res.json();
//       if (res.ok) {
//         setMessage("✏️ Department updated!");
//         setIsEditing(null);
...
//       setMessage("❌ Server error while updating department.");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       const data = await res.json();
//       if (res.ok) {
//         setMessage("🗑️ Department deleted!");
//         fetchDepartments();
//       } else {
...
//       setMessage("❌ Server error while deleting department.");
//     }
//   };

//   return (
//     <div className="p-6">
//       <h2 className="text-2xl font-bold text-green-700 mb-4">🏛 Manage Departments</h2>
